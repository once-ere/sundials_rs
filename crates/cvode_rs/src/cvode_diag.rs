/* -----------------------------------------------------------------
 * Translated from src/cvode/cvode_diag.c (CVODE 7.7.0).
...
use crate::sundials_types::SUNTRUE;
...
pub fn CVDiag(cv_mem: &mut CVodeMem) -> i32 {
    ...
    /* Set four main function fields in cv_mem: handled by the
       LsModule::Diag dispatch in cvode.rs. */
