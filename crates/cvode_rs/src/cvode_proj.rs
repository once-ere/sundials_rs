/* ---------------------------------------------------------------------------
 * Translated from src/cvode/cvode_proj.c (CVODE 7.7.0).
 ...
 * ---------------------------------------------------------------------------*/
use crate::cvode::{cvRescale, cvRestore};
use crate::cvode_impl::*;
use crate::cvode_proj_impl::*;
...
/* (ONEPSM = 1.000001 comes from cvode_impl) */

const MSG_CV_PROJ_MEM_NULL: &str = "proj_mem = NULL illegal.";
