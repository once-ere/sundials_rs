/* -----------------------------------------------------------------
 * Translated from examples/cvode/serial/cvsRoberts_dns_uw.c
 * (CVODE 7.7.0)
 *
 * Chemical kinetics 3-species problem (see cvRoberts_dns), solved
 * with BDF + Newton + dense linear solver and a user-supplied
 * Jacobian. Instead of tolerances, a user-supplied function
 * computes the error weights required for the WRMS norm.
 * -----------------------------------------------------------------*/
