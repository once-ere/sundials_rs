...
- [ ] arkode_mristep_controller.c — DEFERRED (the mriStepControlContent wrapper stores raw ark_mem/step_mem back-pointers that safe Rust cannot express; needed only for MRI-H-TOL adaptivity — redesign alongside the ark_kpr_mri H-TOL variants)
